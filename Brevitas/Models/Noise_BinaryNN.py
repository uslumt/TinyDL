...
In this module we tried to add random distribution to weights see NoiseQuantConv class
 
@author: uslumt
"""

from torch.nn import Module
from brevitas.nn import  QuantIdentity, QuantReLU, QuantLinear, QuantMaxPool2d, BatchNorm2dToQuantScaleBias
from brevitas.inject.enum import QuantType
from NoiseQuant import NoiseQuantConv
...
class Net(Module):
    ...
    def __init__(self):
        ...
        self.qconv1 = NoiseQuantConv(3, 6, 5, weight_quant_type = QuantType.BINARY, weight_bit_width = 1 )  
        self.pool1 = QuantMaxPool2d(2, 2)     
        self.BN1 = BatchNorm2dToQuantScaleBias(6, affine = False)           
        self.relu1 = QuantReLU(bit_width = 2)                  
        self.qconv2 = NoiseQuantConv(6, 16, 5, weight_quant_type = QuantType.BINARY, weight_bit_width = 1 )
