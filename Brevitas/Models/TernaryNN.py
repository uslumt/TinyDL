...
In this module we implemented Ternary quantization,
during the training execution of weigths we shoud be able see 3 level outputs
...
class Net(Module):
    ...
    def __init__(self):
        ...
        self.qconv1 = QuantConv2d(3, 6, 5, weight_bit_width = 2, narrow_range = True )  
        self.pool1 = QuantMaxPool2d(2, 2)                                                      
        self.BN1 = BatchNorm2dToQuantScaleBias(6, affine = False)           
        self.relu1 = QuantReLU(bit_width = 2)
        self.qconv2 = QuantConv2d(6, 16, 5, weight_bit_width = 2, narrow_range = True )
        self.BN2 =  BatchNorm2dToQuantScaleBias(16, affine = False)
        self.pool2 = QuantMaxPool2d(2, 2)
        self.relu2 = QuantReLU(bit_width = 2)
        self.fc1 = QuantLinear(400, 100,bias = True, weight_bit_width = 2, narrow_range = True )
        self.fc2 = QuantLinear(100, 50,bias = True, weight_bit_width = 2, narrow_range = True )
        self.fc3 = QuantLinear(50, 10,bias = True,  weight_bit_width = 2, narrow_range = True )
